...
const ThemeToggler = () => {
  ...
  if (!mounted) {
    ...
    return <div className="w-16 h-8 invisible scale-75 lg:scale-90"></div>;
  }

  return (
    <div
      onClick={toggleTheme}
      className="relative w-16 h-8 scale-75 lg:scale-90 flex items-center dark:bg-gray-900 dark:border dark:border-white/30 bg-indigo-500 cursor-pointer rounded-full p-1"
    >
